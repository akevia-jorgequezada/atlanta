	...
	<?php else : ?>
		<section class="content">
			...
			<?php else : ?>
				...
				<p>
					<em>
						<?php printf( _n( 'This gallery contains <a %1$s>%2$s photo</a>.', 'This gallery contains <a %1$s>%2$s photos</a>.', $total_images, DPTPLNAME ),
						'href="' . esc_url( get_permalink() ) . '" title="' . sprintf( esc_attr__( 'Permalink to %s', DPTPLNAME ), the_title_attribute( 'echo=0' ) ) . '" rel="bookmark"',
