...
jQuery(document).ready(function() {
    if (
        jQuery(window).width() > jQuery(document.body).attr("data-tablet-width")
    ) {
        if (jQuery("#main-menu")) {
            ...
            jQuery("#main-menu li").each(function(i, el) {
                ...
                if (jQuery(el).attr("data-submenu-width") != null) {
                    ...
                    jQuery(childel)
                        .find(".sub-menu:first")
                        .css("margin-left", submenuwidth - 20);
                }
            });
            ...
            jQuery("#main-menu li a").each(function(i, el) {
                ...
                if (
                    el.parent().hasClass("haschild") &&
                    jQuery(document.body).attr("data-tablet") != null
                ) {
                    el.click(function(e) {
                    ...
                    base.find("li.haschild").each(function(i, el) {
                        ...
                        if (el.children(".sub-menu").length > 0) {
                            ...
                            el.mouseenter(function() {
                                ...
                                content.animate(fxEnd, duration, function() {
                            ...
                            el.mouseleave(function() {
                                ...
                                //
                                content.animate(fxStart, duration, function() {
                                    if (content.outerHeight() == 0) {
                                        content.css("overflow", "hidden");
                                    } else if (
                                        content.outerHeight() - prevh < 30 &&
