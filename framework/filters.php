...
function gavern_custom_die_handler( $message, $title = '', $args = array() ) {
	...
	if ( isset( $r['back_link'] ) && $r['back_link'] ) {
		$back_text = $have_gettext? __('&laquo; Back', DPTPLNAME) : '&laquo; Back';
	...
	if ( !function_exists( 'did_action' ) || !did_action( 'admin_head' ) ) :
		...
		if ( empty($title) )
			$title = $have_gettext ? __('WordPress &rsaquo; Error', DPTPLNAME) : 'WordPress &rsaquo; Error';
...
<?php endif; ?>
	...
	<?php echo $message; ?>
	<p class="errorinfo"><a href="./index.php"><?php _e('Homepage', DPTPLNAME); ?></a></p>
</body>
</html>
<?php
	die();
