...
class DP_Comments_Widget extends WP_Widget {
	 ...
	 *
	 **/
	function DP_Comments_Widget() {
		$this->WP_Widget(
			'widget_dp_comments', 
			__( 'DP Comments', DPTPLNAME ), 
			array( 
				'classname' => 'widget_dp_comments', 
				'description' => __( 'Use this widget to show recent comments with avatars', DPTPLNAME) 
			)
		);
	...
	function widget($args, $instance) {
		...
		$title = apply_filters('widget_title', empty($instance['title']) ? __( 'Latest Comments', DPTPLNAME ) : $instance['title'], $instance, $this->id_base);
	...
	?>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'avatar_size' ) ); ?>"><?php _e( 'Avatar size:', DPTPLNAME ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'word_count' ) ); ?>"><?php _e( 'Word count:', DPTPLNAME ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'number' ) ); ?>"><?php _e( 'Number of comments:', DPTPLNAME ); ?></label>
