...
<head>
	<title><?php echo 'Columns Shortcodes Panel'; ?></title>
	...
	<script language="javascript" type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/framework/tinymce/js/columns_dialog.js"></script>
...
<body>
    ...
    <div class="panel_wrapper" style="height:280px;">
				...
				<table border="0" cellpadding="4" cellspacing="0">
				 <tr>
					<td nowrap="nowrap"><label for="columns_shortcode" style="font-size:12px;">Select One:</label></td>
					<td> 
                    
                    <select name="dp-columns-shortcode" id="dp-columns-shortcode" style="width:420px;">
