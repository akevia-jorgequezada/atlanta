...
function insertShortcode() {
	...
	var buttonTColor = document.getElementById('button_text').value;
		...
		{
		shortcodeText = "[button size='"+buttonSize+"' style='"+buttonStyle+"' link='"+buttonUrl+"' linktarget='"+buttonTarget+"']"+buttonText+"[/button]"+" ";
		}} else { 
		shortcodeText = "[button size='"+buttonSize+"' bgColor='"+buttonColor+"' textColor ='"+buttonTColor+"' link='"+buttonUrl+"' linktarget='"+buttonTarget+"']"+buttonText+"[/button]"+" ";}
